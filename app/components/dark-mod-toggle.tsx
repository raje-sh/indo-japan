...
const [DARK_MODE, LS_THEME_KEY] = ['dark', 'theme'];
...
const DarkModeToggle: React.FC = () => {
    ...
    return (
        <button className="p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-sky-400" onClick={() => setDarkStatus(!isDark)}>
